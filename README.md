...
Make sure you have [Node.js](https://nodejs.org/en/) and npm (Node Package Manager) installed.
...
1.  **Clone the repository:**
    ...
    ```bash
    git clone [https://github.com/raymondoyondi/Advice-Generator.git](https://github.com/raymondoyondi/Advice-Generator.git)
    cd advice-generator
    ```
